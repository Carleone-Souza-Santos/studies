        ...
        {projetos.map((proj) => (
          ...
          >
            ...
            >
              ...
              <p className="text-center text-gray-300 text-xs md:text-sm">{proj.instituicao}</p>
              <p className="text-center text-gray-400 text-xs md:text-sm mt-1">{proj.linguagem}</p>
              <p className="text-center text-gray-400 text-xs md:text-sm mt-1">{proj.ano}</p>
            </motion.div>
          </a>
        ))}
      </div>
